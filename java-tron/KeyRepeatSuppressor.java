/* This is a java program that I downloaded off of the Internet from 
 * http://elionline.co.uk/blog/2012/07/12/ignore-key-repeats-in-java-swing-independently-of-platform/ 
 *
 * It inherits from KeyListener.
 * This is used to fix a bug where on linux, Java will create multiple "key pressed" and "key released" events.
 * Windows and Mac don't suffer from this bug and if Tron was run on a Windows machine this class would just
 * be a normal KeyListener.
 * 
 * The methods I used:
 *  - installTo(Component component): calls component.addKeyListener()
 *  - getKeysDown(): returns a List of UNIQUE key codes.
 */
